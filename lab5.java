...
and methods getArea and getPerimeter.Create a class RightTriangle with three instance variables of type double called base, height, 
and hypotenuse. 
...
and methods getArea and getPerimeter.Then create a test application which queries the user for the needed data to create two Circle objects 
